...
int main(int argc, char *argv[])
{
  ...
  auto const shift_queries = !vm.count("shift-queries");
  ...
  auto const perform_knn_search = !vm.count("do-not-perform-knn-search");
  auto const perform_radius_search = !vm.count("do-not-perform-radius-search");
