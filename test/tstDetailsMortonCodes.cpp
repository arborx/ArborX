...
BOOST_AUTO_TEST_CASE(expand_bits)
{
  ...
  BOOST_TEST(expandBitsBy<7>(x) == 0b00000001000000010000000000000001u);
  BOOST_TEST(expandBitsBy<8>(x) ==      0b000000001000000000000000001u);
  ...
  BOOST_TEST(expandBitsBy<4>(y) ==    0b000010000100001000010000100001000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<5>(y) ==    0b000001000001000001000001000000000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<6>(y) == 0b000000100000010000001000000000000000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<7>(y) ==        0b00000001000000000000000000000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<8>(y) == 0b000000001000000000000000000000000000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<9>(y) ==    0b000000000000000000000000000000000000000000000000000000000001llu);
  // clang-format on
}
