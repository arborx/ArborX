...
BOOST_AUTO_TEST_CASE(expand_bits)
{
  ...
  BOOST_TEST(expandBitsBy<1>(x) == 0b010100000100000101010001);
  BOOST_TEST(expandBitsBy<2>(x) == 0b000000001000000001001001000001);

  unsigned long long y = 0b11111111111111000001;
  BOOST_TEST(expandBitsBy<1>(y) == 0b0101010101010101010101010101000000000001);
  BOOST_TEST(expandBitsBy<2>(y) == 0b001001001001001001001001001001001001001001000000000000000001);
}
