...
BOOST_AUTO_TEST_CASE(expand_bits)
{
  ...
  BOOST_TEST(expandBitsBy<7>(y) ==
             0b00000001000000000000000000000000000000000000000000000001llu);
  BOOST_TEST(
      expandBitsBy<8>(y) ==
      0b000000001000000000000000000000000000000000000000000000000000001llu);
  BOOST_TEST(expandBitsBy<9>(y) ==
             0b000000000000000000000000000000000000000000000000000000000001llu);
}
