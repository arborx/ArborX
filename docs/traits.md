...
struct Access;
```
The struct template `ArborX::Traits::Access` tells the [`ArborX::BVH` constructor](https://github.com/dalg24/ArborX/blob/docs/docs/bounding_volume_hierarchy.md#arborxbvhdevicetypebvh) how much data to index and how to access that data,
or [`ArborX::BVH::query()`](https://github.com/dalg24/ArborX/blob/docs/docs/bounding_volume_hierarchy.md#arborxbvhdevicetypequery) what predicates to query for.
