...
#### Type requirements
A specialization of [`ArborX::Traits::Access`](https://github.com/arborx/ArborX/blob/docs/docs/traits.md#arborxtraitsaccess) must match `Primitives` as the first template argument and `PrimitivesTag` as second argument.  
...
#### Type requirements
A specialization of [`ArborX::Traits::Access`](https://github.com/arborx/ArborX/blob/docs/docs/traits.md#arborxtraitsaccess) must match the `Predicates` as first template argument and `PredicatesTag` as second argument.  
...
* [`ArborX::nearest()`](https://github.com/arborx/ArborX/blob/docs/docs/predicates.md#arborxnearest)
* [`ArborX::intersects()`](https://github.com/arborx/ArborX/blob/docs/docs/predicates.md#arborxintersects)
