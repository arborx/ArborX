...
class FineSearch
{
  public:
     ...
     * physical space (not duplicated) (n_phys_pts, dim)
     *    @param[in] cells Cells owned by the processor (n_cells, n_nodes, dim)
     *    @param[in] coarse_search_output_points Indices of physical points from
     * the coarse search (coarse_output_size)
